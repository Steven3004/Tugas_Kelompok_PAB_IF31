...
import 'package:projek_uas/screen/detail_screen.dart';
import 'package:projek_uas/screen/sign_in_screen.dart';
import 'package:projek_uas/screen/theme_provider.dart';
import 'package:projek_uas/screen/favorite_screen.dart';
import 'package:projek_uas/screen/search_screen.dart';
    ...
    Navigator.of(context).push(
      PageRouteBuilder(
        pageBuilder: (context, animation, secondaryAnimation) => DetailScreen(
          postId: postId,
          userId: userId,
          imageUrl: imageBase64 ?? '', // Fixed: Use imageUrl instead of imageBase64
          title: title ?? '', // Fixed: Provide default empty string
          description: description ?? '', // Fixed: Provide default empty string
          createdAt: createdAt,
          fullName: fullName,
          subtitle: '',
          initiallyFavorite: false, // Fixed: Provide boolean value instead of null
        ),
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                Hero(
                                  tag: 'user_avatar_${userId}_$postId',
                                  child: CircleAvatar(
                                    radius: 20,
